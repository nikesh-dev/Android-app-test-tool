...
public class Nativenput {
	...
	public class InputDevice {
		...
		public int SendTouchButton(boolean state) {
			...
			/*
			 * { intSendEvent(m_nId, EV_ABS, 24,1); intSendEvent(m_nId, EV_ABS,
			 * 28,1); intSendEvent(m_nId, 1, 330, 1); // touch down }
			 */
			else
				return intSendEvent(m_nId, EV_KEY, BTN_TOUCH, 0); // touch up
			/*
			 * { intSendEvent(m_nId, EV_ABS, 24,0); intSendEvent(m_nId, EV_ABS,
			 * 28,0); intSendEvent(m_nId, 1, 330, 0); // touch down }
			 */
			// return 1;
		}
		...
		public int SendTouchDown(int x, int y, int screenW, int screenH) {
			int absx = (570 * x) / screenW, absy = (950 * x) / screenH;
	...
	// public native static String nike();
	...
	private native static String nike1();

	private native static void getMessage(String img);
